...
const pdaSeedFunctionMap: Record<string, string> = {
  ...
  commitment_campaign: 'deriveCommitmentCampaignPda',
  commitment_payment_rail: 'deriveCommitmentPaymentRailPda',
  commitment_ledger: 'deriveCommitmentLedgerPda',
  commitment_position: 'deriveCommitmentPositionPda',
