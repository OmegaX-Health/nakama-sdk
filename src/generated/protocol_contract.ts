...
export const PROTOCOL_PROGRAM_ID =
  '6EXiDfGVbG7V1X2xaEALDZ7CtSuezkM8ZvXXFpk5WxQM' as const;
...
> = {
  ...
  deposit_reserve_capital: Uint8Array.from([
    131, 164, 249, 242, 239, 66, 61, 250,
  ]),
      ...
      pdaSeeds: [
        {
          kind: 'const',
          value: [
            99, 97, 112, 105, 116, 97, 108, 95, 99, 111, 110, 116, 114, 105, 98,
            117, 116, 105, 111, 110,
          ],
        },
        { kind: 'account', path: 'funding_line' },
  ...
  return_reserve_capital: [
    ...
    },
    {
      ...
      pdaSeeds: [
        ...
        { kind: 'account', path: 'funding_line' },
        { kind: 'account', path: 'capital_contribution.contributor' },
      ],
    },
    {
      name: 'funding_line_ledger',
