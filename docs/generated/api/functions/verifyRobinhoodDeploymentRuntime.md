...
[@nakama-health/protocol-sdk](../README.md) / verifyRobinhoodDeploymentRuntime

# Function: verifyRobinhoodDeploymentRuntime()
...
Defined in: [src/robinhood/artifacts.ts:660](https://github.com/OmegaX-Health/nakama-sdk/blob/main/src/robinhood/artifacts.ts#L660)
...
`Promise`\<[`VerifiedRobinhoodDeploymentRuntime`](../interfaces/VerifiedRobinhoodDeploymentRuntime.md)\>
