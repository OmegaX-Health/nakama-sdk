...
[@nakama-health/protocol-sdk](../README.md) / verifyEthereumTransactionIntent

# Function: verifyEthereumTransactionIntent()

> **verifyEthereumTransactionIntent**(`client`, `options`): `Promise`\<[`VerifiedEthereumTransactionIntent`](../interfaces/VerifiedEthereumTransactionIntent.md)\>

Defined in: src/ethereum\_contract.ts:472
...
\<`client`\>(`fn`) => `Client`\<`Transport`, `Chain` \| `undefined`, `undefined`, `PublicRpcSchema`, \{ \[K in string \| number \| symbol\]: client\[K\] \} & `PublicActions`\<`Transport`, `Chain` \| `undefined`, `undefined`, `Tokens` \| `undefined`\>, `Tokens` \| `undefined`\>
...
\<`abi`, `functionName`, `args`, `chainOverride`, `accountOverride`\>(`args`) => `Promise`\<`SimulateContractReturnType`\<`abi`, `functionName`, `args`, `Chain` \| `undefined`, `undefined`, `chainOverride`, `accountOverride`\>\>
...
\{ `getAllowance`: (`parameters`) => `Promise`\<`Amount`\> & `object`; `getBalance`: (`parameters`) => `Promise`\<`Amount`\> & `object`; `getMetadata`: (`parameters`) => `Promise`\<`ReturnValue`\>; `getTotalSupply`: (`parameters`) => `Promise`\<`Amount`\> & `object`; \}
...
(`parameters`) => `Promise`\<`Amount`\> & `object`
...
`Promise`\<[`VerifiedEthereumTransactionIntent`](../interfaces/VerifiedEthereumTransactionIntent.md)\>
