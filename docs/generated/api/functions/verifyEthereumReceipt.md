...
[@nakama-health/protocol-sdk](../README.md) / verifyEthereumReceipt

# Function: verifyEthereumReceipt()

> **verifyEthereumReceipt**(`client`, `options`): `Promise`\<[`VerifiedEthereumReceipt`](../interfaces/VerifiedEthereumReceipt.md)\>

Defined in: src/ethereum\_contract.ts:592
