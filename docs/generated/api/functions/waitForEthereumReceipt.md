...
[@nakama-health/protocol-sdk](../README.md) / waitForEthereumReceipt

# Function: waitForEthereumReceipt()

> **waitForEthereumReceipt**(`client`, `options`): `Promise`\<[`VerifiedEthereumReceipt`](../interfaces/VerifiedEthereumReceipt.md)\>

Defined in: src/ethereum\_contract.ts:574
...
[`VerifyEthereumReceiptOptions`](../interfaces/VerifyEthereumReceiptOptions.md) & `object`

## Returns

`Promise`\<[`VerifiedEthereumReceipt`](../interfaces/VerifiedEthereumReceipt.md)\>
