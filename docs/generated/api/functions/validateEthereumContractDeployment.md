...
[@nakama-health/protocol-sdk](../README.md) / validateEthereumContractDeployment

# Function: validateEthereumContractDeployment()

> **validateEthereumContractDeployment**(`params`): `Promise`\<[`EthereumDeploymentManifest`](../interfaces/EthereumDeploymentManifest.md)\>

Defined in: src/ethereum\_deployment.ts:417
...
`Promise`\<[`EthereumDeploymentManifest`](../interfaces/EthereumDeploymentManifest.md)\>
